...
object CatsIntro extends App {
  ...
  // Eq
//  val aComparison = 2 == "a string" -- this is wrong, it will trigger a compiler warning, it will always return false
...
//  val anUnsafeComparison = intEquality.eqv(2, "a string") -- doesn't compile
  ...
  // val invalidComparison = 2 === "a String" -- this doesn't not compile
